...
def save_and_validation(accelerator, opt, EDLoRA_trainer, val_dataloader, global_step, logger):
    ...
    if opt['val']['val_during_save']:
        ...
        for lora_alpha in opt['val']['alpha_list']:
            ...
            pipe, new_concept_cfg = convert_edlora(pipe, torch.load(save_path), enable_edlora=enable_edlora, alpha=lora_alpha, n_layers=16)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-opt', type=str, default='configs/edlora/train/chow_dog.yml')
