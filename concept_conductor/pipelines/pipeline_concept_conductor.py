...
class ConceptConductorPipeline(StableDiffusionPipeline): 
    ...
    def __call__(
        ...
        latents_outdir: str = "outputs/inverted_latents",
        self_attn_outdir: str = "outputs/self_attn",
        cross_attn_outdir: str = "outputs/cross_attn",
        feature_mask_outdir: str = "outputs/feature_mask",
        ...
        **kwargs,
        ...
        for rid, custom_prompt in enumerate(custom_prompts):
            if edloras:
                ...
                new_prompts = [custom_prompt] * 16
                for idx, (concept_name, concept_embedding) in enumerate(new_concept_embedding.items()):
                             
                    new_token_names = [f'<new{idx * 16 + layer_id}>' for layer_id in range(16)]
                ...
                custom_negative_prompt_embeds = custom_negative_prompt_embeds.unsqueeze(dim=0).repeat(bs,16,1,1) 
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for step, t in enumerate(timesteps):
                ...
                requires_attn_guidance = (step <= attn_guidance_end)
