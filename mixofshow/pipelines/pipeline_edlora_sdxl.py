...
from mixofshow.models.edlora_sdxl import (revise_edlora_unet_attention_controller_forward,
...
class SDXLEDLoRAPipeline(StableDiffusionXLPipeline):
    r"""
    ...
    def _encode_prompt(self,
        ...
        if prompt_embeds is None:
            ...
            if isinstance(prompt_2, str):
                prompt_2 = [prompt_2]
            n_layers = len(prompt_embeds) // batch_size
            prompt_extend_2 = [[p] * n_layers for p in prompt_2]
            prompt_extend_2 = list(itertools.chain.from_iterable(prompt_extend_2))
        ...
        # bs_embed, n_layers, seq_len, hidden_dim = prompt_embeds.shape
        ...
        if do_classifier_free_guidance:
            ...
            # print('neg:')
            # print(negative_prompt_embeds[0])
            # print('pos:')
    ...
    def __call__(
        ...
        **kwargs,
        ...
        (
            ...
            prompt=prompt,
            prompt_2=prompt_2,
            new_concept_cfg=self.new_concept_cfg,
            device=device,
